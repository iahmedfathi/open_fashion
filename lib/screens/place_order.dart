...
import 'package:open_fashion/screens/add_card_view.dart';
...
class _PlaceOrderViewState extends State<PlaceOrderView> {
  ...
  void _openAddress(context) async {
    final addressData = await Navigator.push(
      context,
      MaterialPageRoute(builder: (c) => AddAddressView()),
    );
  ...
  void _editAddress() async {
    final newAddress = await Navigator.push(
      context,
      MaterialPageRoute(builder: (c) => AddAddressView(editData: _savedAddress)),
    );
  ...
  void _openCard() async {
    final cardData = await Navigator.push(
      context,
      MaterialPageRoute(builder: (c) => AddCardView()),
    );
